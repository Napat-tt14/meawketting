...
INSERT OR IGNORE INTO booking_services (
  ...
  ('onnut-daycare-full-day', 'business-paw-partner', 'partner-onnut', 'daycare', 'Daycare เต็มวัน', 'day', NULL, 450, 'active', '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001');
...
INSERT OR IGNORE INTO booking_service_resource_requirements (
  ...
  ('business-paw-partner', 'partner-onnut', 'onnut-daycare-full-day', 'daycare-zone', 0, '2026-08-17T03:00:00.000Z', 'prs_01k47meawketting000000001');
...
INSERT OR IGNORE INTO booking_resources (
  ...
  ('onnut-daycare-quiet', 'business-paw-partner', 'partner-onnut', 'daycare', 'daycare-zone', 'โซนสงบ', 'capacity', 6, NULL, NULL, 'active', '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001');
...
INSERT OR IGNORE INTO booking_resource_service_links (
  ...
  ('business-paw-partner', 'partner-onnut', 'onnut-daycare-quiet', 'onnut-daycare-full-day', '2026-08-17T03:00:00.000Z', 'prs_01k47meawketting000000001');
...
INSERT OR IGNORE INTO booking_resource_availability_windows (
  ...
  ('be3-team-pim-working', 'business-whisker-rest', 'whisker-ari', 'ari-groomer-pim', 'working', '2026-08-18T08:00', '2026-08-18T18:00', CAST(strftime('%s','2026-08-18T08:00:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-18T18:00:00Z')/60 AS INTEGER), '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001'),
  ('be3-team-pim-break', 'business-whisker-rest', 'whisker-ari', 'ari-groomer-pim', 'break', '2026-08-18T12:00', '2026-08-18T13:00', CAST(strftime('%s','2026-08-18T12:00:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-18T13:00:00Z')/60 AS INTEGER), '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001'),
  ('be3-team-joy-working', 'business-whisker-rest', 'whisker-ari', 'ari-groomer-joy', 'working', '2026-08-18T08:00', '2026-08-18T18:00', CAST(strftime('%s','2026-08-18T08:00:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-18T18:00:00Z')/60 AS INTEGER), '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001'),
  ('be3-team-nok-working', 'business-whisker-rest', 'whisker-thonglor', 'thonglor-groomer-nok', 'working', '2026-08-18T08:00', '2026-08-18T17:00', CAST(strftime('%s','2026-08-18T08:00:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-18T17:00:00Z')/60 AS INTEGER), '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001');
...
INSERT OR IGNORE INTO bookings (
  ...
  ('booking-fixture-ari-grooming-1030', 'business-whisker-rest', 'whisker-ari', 'booking-contact-nalin', 'ari-grooming-bath-groom', 'grooming', 'appointment', '2026-08-18T10:30', '2026-08-18T12:00', CAST(strftime('%s','2026-08-18T10:30:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-18T12:00:00Z')/60 AS INTEGER), 'tuesday', 'confirmed', 850, 'ใช้ตรวจสอบเวลาชน', 1, 'seed:grooming-1030', NULL, NULL, '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', NULL, 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001', NULL),
  ('booking-fixture-ari-grooming-biscuit', 'business-whisker-rest', 'whisker-ari', 'booking-contact-nalin', 'ari-grooming-bath-groom', 'grooming', 'appointment', '2026-08-18T08:00', '2026-08-18T09:00', CAST(strftime('%s','2026-08-18T08:00:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-18T09:00:00Z')/60 AS INTEGER), 'tuesday', 'arrived', 850, 'งานเช้าที่เสร็จแล้วสำหรับตรวจประวัติบริการ', 1, 'seed:grooming-biscuit', NULL, NULL, '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', NULL, 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001', NULL),
  ('booking-fixture-ari-grooming-tofu-active', 'business-whisker-rest', 'whisker-ari', 'booking-contact-pim', 'ari-grooming-bath-groom', 'grooming', 'appointment', '2026-08-18T09:15', '2026-08-18T10:45', CAST(strftime('%s','2026-08-18T09:15:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-18T10:45:00Z')/60 AS INTEGER), 'tuesday', 'arrived', 850, 'ใช้แสดงงานที่กำลังรอช่างรับช่วง', 1, 'seed:grooming-tofu', NULL, NULL, '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', NULL, 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001', NULL),
  ('booking-fixture-ari-grooming-milo', 'business-whisker-rest', 'whisker-ari', 'booking-contact-nalin', 'ari-grooming-bath-groom', 'grooming', 'appointment', '2026-08-18T12:15', '2026-08-18T13:45', CAST(strftime('%s','2026-08-18T12:15:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-18T13:45:00Z')/60 AS INTEGER), 'tuesday', 'arrived', 850, 'รอเจ้าของมารับหลังเสร็จบริการ', 1, 'seed:grooming-milo', NULL, NULL, '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', NULL, 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001', NULL),
  ('booking-fixture-ari-grooming-luna', 'business-whisker-rest', 'whisker-ari', 'booking-contact-pim', 'ari-grooming-bath-groom', 'grooming', 'appointment', '2026-08-18T14:30', '2026-08-18T16:00', CAST(strftime('%s','2026-08-18T14:30:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-18T16:00:00Z')/60 AS INTEGER), 'tuesday', 'confirmed', 850, 'มีสิทธิ์สแกนรับเข้าเพื่อเชื่อม Intake กับงานนี้', 1, 'seed:grooming-luna', NULL, NULL, '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', NULL, 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001', NULL),
  ('booking-fixture-ari-hotel-luna', 'business-whisker-rest', 'whisker-ari', 'booking-contact-pim', 'ari-hotel-stay', 'hotel', 'date-range', '2026-08-18', '2026-08-21', CAST(strftime('%s','2026-08-18T00:00:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-21T00:00:00Z')/60 AS INTEGER), 'tuesday', 'confirmed', 3600, 'เข้าพัก 3 คืน', 1, 'seed:hotel-luna', NULL, NULL, '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', NULL, 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001', NULL),
  ('booking-fixture-ari-hotel-biscuit-checkout', 'business-whisker-rest', 'whisker-ari', 'booking-contact-nalin', 'ari-hotel-stay', 'hotel', 'date-range', '2026-08-16', '2026-08-18', CAST(strftime('%s','2026-08-16T00:00:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-18T00:00:00Z')/60 AS INTEGER), 'sunday', 'confirmed', 2400, 'เตรียมรับกลับวันนี้', 1, 'seed:hotel-biscuit', NULL, NULL, '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', NULL, 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001', NULL),
  ('booking-fixture-ari-hotel-milo', 'business-whisker-rest', 'whisker-ari', 'booking-contact-nalin', 'ari-hotel-stay', 'hotel', 'date-range', '2026-08-19', '2026-08-20', CAST(strftime('%s','2026-08-19T00:00:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-20T00:00:00Z')/60 AS INTEGER), 'wednesday', 'confirmed', 1200, 'พื้นที่พักเต็มในวันที่ 19 สิงหาคม', 1, 'seed:hotel-milo', NULL, NULL, '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', NULL, 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001', NULL),
  ('booking-fixture-ari-hotel-nalin-pair', 'business-whisker-rest', 'whisker-ari', 'booking-contact-nalin', 'ari-hotel-stay', 'hotel', 'date-range', '2026-08-24', '2026-08-26', CAST(strftime('%s','2026-08-24T00:00:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-26T00:00:00Z')/60 AS INTEGER), 'monday', 'confirmed', 4800, 'ลูกค้าเข้าพักพร้อมน้องสองตัว แต่ต้องจัดห้องและดูแลแยกกัน', 1, 'seed:hotel-pair', NULL, NULL, '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', NULL, 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001', NULL),
  ('booking-fixture-ari-cancelled', 'business-whisker-rest', 'whisker-ari', 'booking-contact-pim', 'ari-grooming-bath-groom', 'grooming', 'appointment', '2026-08-18T14:00', '2026-08-18T15:30', CAST(strftime('%s','2026-08-18T14:00:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-18T15:30:00Z')/60 AS INTEGER), 'tuesday', 'cancelled', 850, 'ยกเลิกแล้ว จึงไม่กินเวลาหรือทรัพยากร', 1, 'seed:cancelled', NULL, NULL, '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', '2026-08-17T04:00:00.000Z', 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001'),
  ('booking-fixture-thonglor-grooming', 'business-whisker-rest', 'whisker-thonglor', 'booking-contact-pim', 'thonglor-grooming-bath', 'grooming', 'appointment', '2026-08-18T10:45', '2026-08-18T11:45', CAST(strftime('%s','2026-08-18T10:45:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-18T11:45:00Z')/60 AS INTEGER), 'tuesday', 'confirmed', 650, 'ตรวจสอบรายการก่อนเริ่มงาน', 1, 'seed:thonglor-grooming', NULL, NULL, '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', NULL, 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001', NULL),
  ('booking-fixture-onnut-daycare-full', 'business-paw-partner', 'partner-onnut', 'booking-contact-onnut-aom', 'onnut-daycare-full-day', 'daycare', 'day', '2026-08-18', NULL, CAST(strftime('%s','2026-08-18T00:00:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-19T00:00:00Z')/60 AS INTEGER), 'tuesday', 'confirmed', 900, 'สองรายการทำให้โซนสังคมเต็มในวันที่ 18 สิงหาคม', 1, 'seed:daycare-full', NULL, NULL, '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', NULL, 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001', NULL),
  ('booking-fixture-onnut-hotel-leo', 'business-paw-partner', 'partner-onnut', 'booking-contact-onnut-lee', 'onnut-hotel-stay', 'hotel', 'date-range', '2026-08-18', '2026-08-20', CAST(strftime('%s','2026-08-18T00:00:00Z')/60 AS INTEGER), CAST(strftime('%s','2026-08-20T00:00:00Z')/60 AS INTEGER), 'tuesday', 'pending', 2000, 'ตรวจสอบรายการก่อนเริ่มงาน', 1, 'seed:hotel-leo', NULL, NULL, '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', NULL, 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001', NULL);

INSERT OR IGNORE INTO booking_pets (business_id, branch_id, booking_id, pet_id, position, created_at, created_by_person_id) VALUES
  ...
  ('business-paw-partner','partner-onnut','booking-fixture-onnut-hotel-leo','booking-pet-leo',0,'2026-08-17T03:00:00.000Z','prs_01k47meawketting000000001');

INSERT OR IGNORE INTO booking_resource_assignments (
  ...
  ('business-paw-partner','partner-onnut','booking-fixture-onnut-hotel-leo','onnut-hotel-capacity',0,'2026-08-17T03:00:00.000Z','prs_01k47meawketting000000001');

INSERT OR IGNORE INTO booking_resource_reservations (
...
WHERE resource.capacity_mode = 'exclusive';
...
SELECT business_id, branch_id, booking_id, resource_id,
       date(day_minute * 60, 'unixepoch'), date(day_minute * 60, 'unixepoch'), day_minute, day_minute + 1440, units
FROM capacity_days;
