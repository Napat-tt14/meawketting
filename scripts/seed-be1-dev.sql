...
INSERT OR IGNORE INTO persons (id, display_name, primary_email, status, created_at, updated_at) VALUES
  ...
  ('prs_01k47meawketting000000006', 'บุคคลพักการใช้งาน', 'inactive-person@meawketting.example.test', 'inactive', '2026-09-05T00:00:00.000Z', '2026-09-05T00:00:00.000Z');
...
INSERT OR IGNORE INTO businesses (
  ...
  ('business-paw-partner', 'Paw Partner', 'คุณมายด์', '02-021-4722', 'care@pawpartner.example', 'ทีมดูแลสัตว์เลี้ยงแบบรายวันและเข้าพัก', 'กรุงเทพมหานคร', NULL, 'active', '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001');
...
INSERT OR IGNORE INTO branches (
  ...
  ('partner-onnut', 'business-paw-partner', 'อ่อนนุช', 'อ่อนนุช', 'อ่อนนุช', 'ถนนอ่อนนุช เขตสวนหลวง กรุงเทพฯ', '02-021-4722', 'onnut@pawpartner.example', 'Asia/Bangkok', 'active', '2026-08-17T03:00:00.000Z', '2026-08-17T03:00:00.000Z', 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001');

INSERT OR IGNORE INTO branch_enabled_modules (business_id, branch_id, module, created_at, created_by_person_id) VALUES
  ...
  ('business-paw-partner', 'partner-onnut', 'daycare', '2026-08-17T03:00:00.000Z', 'prs_01k47meawketting000000001');

INSERT OR IGNORE INTO branch_operating_hours (
  ...
  ('business-paw-partner', 'partner-onnut', 'sunday', 0, '09:00', '18:00', '2026-08-17T03:00:00.000Z', 'prs_01k47meawketting000000001');
...
INSERT OR IGNORE INTO business_memberships (
  ...
  ('mem_01k47meawketting000000005', 'prs_01k47meawketting000000004', 'business-paw-partner', 'MANAGER', 'inactive', '2026-09-05T00:05:00.000Z', '2026-09-05T00:05:00.000Z', 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001');

INSERT OR IGNORE INTO membership_branch_access (
  ...
  ('mem_01k47meawketting000000005', 'business-paw-partner', 'partner-onnut', 'active', '2026-09-05T00:10:00.000Z', '2026-09-05T00:10:00.000Z', 'prs_01k47meawketting000000001', 'prs_01k47meawketting000000001');
