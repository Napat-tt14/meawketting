...
- `business-login-welcome.png` is used by `/business/login` as the dedicated transparent auth illustration; the previous `business-auth-welcome.png` asset remains retained for compatibility.
