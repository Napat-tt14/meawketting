...
SELECT 'execution_'||lower(hex(randomblob(16))),b.business_id,b.branch_id,b.id,b.customer_id,p.pet_id,b.service_module,'booked',
...
SELECT 'event_'||lower(hex(randomblob(16))),e.business_id,e.branch_id,e.id,'history:created','สร้างงานจากการจองเดิม','{}',e.created_at
...
SELECT 'assignment_'||lower(hex(randomblob(16))),e.business_id,e.branch_id,e.id,a.resource_id,e.scheduled_start,
